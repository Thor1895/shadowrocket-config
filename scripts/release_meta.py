...
CONFIG_FILE = ROOT / "output" / "shadowrocket.conf"
...
def build_metadata(config_path: Path = CONFIG_FILE, repo: str | None = None) -> dict[str, Any]:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", type=Path, default=CONFIG_FILE, help="Generated Shadowrocket config path.")
    parser.add_argument("--output", type=Path, default=LATEST_FILE, help="Metadata JSON output path.")
